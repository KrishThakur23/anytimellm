  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-white text-slate-900 relative overflow-x-hidden">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center pt-28 pb-16 px-6 max-w-[500px] mx-auto w-full">
        ...
        >
          <div>
            <span className="font-mono text-[9px] tracking-[0.2em] text-purple-600 uppercase font-bold">PHASE 01</span>
            <h3 className="font-display text-2xl tracking-tight text-slate-900 font-extrabold uppercase mt-1 mb-3">NEW WORKSPACE</h3>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className="block font-mono text-[10px] tracking-[0.15em] text-slate-500 uppercase mb-1.5 font-bold">BUSINESS NAME</label>
              <input
                type="text"
                required
                ...
                className="w-full bg-slate-50 border border-slate-200 focus:border-purple-500 focus:bg-white rounded-xl px-4 py-2.5 text-sm text-slate-900 placeholder-slate-400 focus:outline-none uppercase tracking-widest transition-all duration-300"
              />
            </div>
            <div>
            ...
            <div>
              ...
              />
              {password && (
                <div className="mt-3 p-4 bg-slate-50 border border-slate-200 text-[10px] font-mono space-y-1.5 transition-all duration-300 rounded-xl">
                  <span className="block text-slate-700 uppercase tracking-[0.1em] mb-1 font-bold">Password Requirements:</span>
                  <div className="flex items-center gap-2">
                    <span className={isLengthValid ? "text-emerald-600 font-bold" : "text-slate-400"}>
                  ...
                  <div className="flex items-center gap-2">
                    <span className={hasLowercase ? "text-emerald-600 font-bold" : "text-slate-400"}>
          ...
          <div className="mt-8 border-t border-slate-100 pt-6 text-center">
            <span className="font-body text-xs text-slate-500">Already have a workspace? </span>
            <Link 
              href="/login" 
