  ...
  return (
    <div className="min-h-screen w-full flex flex-col bg-black text-white relative overflow-x-hidden">
      ...
      <main className="relative z-10 flex-grow flex flex-col items-center justify-center pt-24 pb-16 px-6 max-w-[500px] mx-auto w-full">
        <div 
          ref={formRef} 
          className="w-full bg-surface-1 border border-border-subtle p-8 md:p-10 rounded-none text-left flex flex-col justify-between transition-colors hover:border-hairline-strong duration-300"
        >
          <div>
            <span className="font-mono text-[9px] tracking-[0.2em] text-muted-gold uppercase">AUTHENTICATION</span>
            <h3 className="font-display-lg text-2xl tracking-[0.1em] text-white uppercase mt-1 mb-3">LOAD WORKSPACE</h3>
          ...
          <div className="mt-8 border-t border-border-subtle/30 pt-6 text-center">
            <span className="font-body-sm text-xs text-on-surface-variant">Don't have a workspace? </span>
            <Link 
              href="/register" 
